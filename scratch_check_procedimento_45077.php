...
$proc = Procedimento::with('paciente', 'aplicacaos.medicamento')->where('id', 45077)->first();

if (!$proc) {
    echo "ERRO: Procedimento 45077 não encontrado.\n";
    exit(1);
}

echo "========== PROCEDIMENTO 45077 ==========\n";
echo "id: {$proc->id}\n";
...
// Aplicações
$aplicacoes = Aplicacao::where('procedimento_id', 45077)->get();
...
// Anexos
$anexos = ProcedimentoAnexo::where('procedimento_id', 45077)->get();
...
// Logs
$logs = ProcedimentoLog::where('procedimento_id', 45077)->get();
...
// Observações
$obs = ProcedimentoObservacao::where('procedimento_id', 45077)->get();
...
$estoques = Estoque::where('procedimento_id', 45077)->get();
...
// EstoqueAberto relacionados via lotes de aplicações
...
// Financeiro
$fins = FinanceiroProcedimento::where('procedimento_id', 45077)->get();
