...
<div class="card card-border-shadow-primary mb-4">
    <div class="card-body">
        <div class="d-flex justify-content-between">
            <h4 class="card-title">Relatório de Enfermagem (Prescrições)</h4>
        </div>
        <hr>
        <form action="{{ route('adm.relatorios2.enfermagem.gerar') }}" method="post">
            @csrf
            ...
            <div class="row mt-2 gy-4">
                ...
                <div class="col-md-3">
                    <div class="form-floating form-floating-outline">
                        ...
                        <label for="dt_inc">Aplicação de:</label>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-floating form-floating-outline">
                        <input class="form-control" type="date" id="dt_fn" name="dt_fn"/>
                        <label for="dt_fn">Aplicação até:</label>
                    </div>
                </div>
            </div>
            <div class="row mt-3">
