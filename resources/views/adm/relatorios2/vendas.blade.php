...
<div class="card card-border-shadow-primary mb-4">
    <div class="card-body">
        <div class="d-flex justify-content-between">
            <h4 class="card-title">Relatório de Vendas (Prescrições)</h4>
        </div>
        <hr>
        <form action="{{ route('adm.relatorios2.vendas.gerar') }}" method="post">
            @csrf
            ...
            <div class="row mt-2 gy-4">
                ...
                <div class="col-md-4">
                    <div class="form-floating form-floating-outline">
                        ...
                        <label for="situacao">Situação do Medicamento:</label>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-floating form-floating-outline">
