...
<div class="card card-border-shadow-primary mb-4">
    <div class="card-body">
        <div class="d-flex justify-content-between">
            <h4 class="card-title">Relatório Financeiro Simplificado</h4>
...
<form target="_blank" id='formulario' action="{{ route('adm.relatorios.exportar_financeiro_simplificado') }}" method="post">
    @csrf
