                    ...
                    <div class="row gy-4 mt-3">
                        <div class="col-md-6">
                            <div class="form-floating form-floating-outline">
                                <select id="pgt_avista" class="select2 form-select">
                                    <option value="Não">Não</option>
                                    <option value="Sim">Sim</option>

                                </select>
                                <label for="clinica_id">Pagamento à vista:</label>
                            </div>
                        </div>
                    </div>
                    <div class="row gy-4 mt-3">
...
document.getElementById('pgt_avista').addEventListener('change', (e)=>{
    if(e.target.value == 'Sim'){
        document.getElementById('porcentagem_desconto').value = 3;
        document.getElementById('obs_pagamento').value = 'Pagamento à vista'
    }
    else{
