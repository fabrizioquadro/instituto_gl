...
/**
 * Tabela mestre da V2: prescrição (tratamento) = também cabeçalho financeiro.
 */
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('prescricaos', function (Blueprint $table) {
            ...
            $table->integer('semana_atual')->default(0);
            $table->decimal('valor_tratamento', 10, 2)->default(0);
            $table->decimal('credito_em_aberto', 10, 2)->default(0);
            $table->string('situacao');
            $table->string('situacao_financeira')->default('Em Aberto');
            $table->timestamps();
